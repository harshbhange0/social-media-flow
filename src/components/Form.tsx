...
import { SignInWithEmailAndPassword, UserSignInTypes } from "@/utils/auth";
    ...
    <>
      ...
      >
        ...
        <p className="text-concrete text-[13px]">
          ...
          agree to Linktree's Terms and Conditions and confirm you have read our
          Privacy Notice. You may receive offers, news and updates from us.
        </p>
      </form>
